  ...
  return (
    <div
      ...
      className={cn(
        ...
        // Animation applied directly (not via the --animate-* theme alias) — see
        // marquee.tsx for why the alias silently never animates when its duration
        // is only set per-instance instead of at :root.
